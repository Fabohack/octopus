...
class TareasControllerTest < ActionController::TestCase
  ...
  test "should create tarea" do
    assert_difference('Tarea.count') do
      post :create, tarea: { complejidad: @tarea.complejidad, descripcion: @tarea.descripcion, puntuacion: @tarea.puntuacion, tiempo_limite: @tarea.tiempo_limite }
    end
  ...
  test "should update tarea" do
    patch :update, id: @tarea, tarea: { complejidad: @tarea.complejidad, descripcion: @tarea.descripcion, puntuacion: @tarea.puntuacion, tiempo_limite: @tarea.tiempo_limite }
    assert_redirected_to tarea_path(assigns(:tarea))
  end
